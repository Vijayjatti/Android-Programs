...
public class PhotoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.photo_notes_activity);
		loadList();
		getItems();
	...
	protected void removeItemFromList(final int position1) {
		...
		alert.setPositiveButton("YES", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				SQLiteDatabase db = new PhotoDbHelper(PhotoActivity.this)
						.getWritableDatabase();
	...
	public void loadList() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent show = new Intent(PhotoActivity.this, PhotoNotesShow.class);
